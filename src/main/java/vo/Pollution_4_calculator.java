...
import dao.Mapper.Pollution_4_Mapper;
import org.apache.ibatis.session.SqlSession;

import java.util.HashMap;
import java.util.Map;

public class Pollution_4_calculator implements TableItem {
    private double a;
    private double q;
    private String year;
    ...
    public void store(SqlSession sqlSession) {
        Pollution_4_Mapper pollution_4_mapper=sqlSession.getMapper(Pollution_4_Mapper.class);
        pollution_4_mapper.insert(this);
    }
